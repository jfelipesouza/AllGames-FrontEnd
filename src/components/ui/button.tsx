...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default: 'bg-primary-300 text-white font-semibold hover:bg-primary-400',
        destructive:
        ...
        secondary:
          'bg-secondary-400 text-white font-semibold hover:bg-secondary-500',
        ghost: 'hover:bg-accent hover:text-accent-foreground font-semibold',
        link: 'text-secondary-500 font-semibold underline-offset-4 hover:underline',
      },
      size: {
